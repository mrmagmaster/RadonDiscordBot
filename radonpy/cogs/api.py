...
class API(commands.Cog):
    ...
    @commands.command(aliases=["gtawasted"], usage=",wasted (felhasználó)")
    ...
    @commands.command(usage=[",tweet [tweet szövege]"])
    ...
    @commands.command(aliases=["atweet", "advtweet"], usage=",advancedtweet [válaszok száma] [likeok száma] [retweetek száma] [üzenet]")
    ...
    @commands.command(aliases=["hexviewer"], usage=",colorviewer [HEX színkód]")
